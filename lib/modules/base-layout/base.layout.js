...
var MaSc5BaseLayout = /** @class */ (function () {
    function MaSc5BaseLayout(route, sc5IdentityService, sc5UtilsService) {
        this.route = route;
        this.sc5IdentityService = sc5IdentityService;
    ...
    MaSc5BaseLayout.prototype.ngOnInit = function () {
        ...
        this.subscription = this.sc5IdentityService.watchIdentity().subscribe(function (identity) {
            if (!!identity) {
    ...
    MaSc5BaseLayout.prototype.ngOnDestroy = function () {
    ...
    MaSc5BaseLayout.ctorParameters = function () { return [
        ...
        { type: identity_1.MaSc5IdentityService, },
