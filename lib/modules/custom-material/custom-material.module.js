...
var MaSc5CustomMaterialModule = /** @class */ (function () {
    function MaSc5CustomMaterialModule(iconRegistry, sanitizer) {
        this.iconRegistry = iconRegistry;
        this.sanitizer = sanitizer;
        this.registerIcons();
    }
    MaSc5CustomMaterialModule.prototype.registerIcons = function () {
    ...
    MaSc5CustomMaterialModule.decorators = [
    ...
    /** @nocollapse */
    MaSc5CustomMaterialModule.ctorParameters = function () { return [
        { type: material_1.MatIconRegistry, },
        { type: platform_browser_1.DomSanitizer, },
    ]; };
    return MaSc5CustomMaterialModule;
}());
exports.MaSc5CustomMaterialModule = MaSc5CustomMaterialModule;
