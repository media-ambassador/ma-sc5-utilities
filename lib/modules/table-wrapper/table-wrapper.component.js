...
var MaSc5TableWrapperComponent = /** @class */ (function () {
    function MaSc5TableWrapperComponent(translateService) {
        ...
        this.rangeLabel = function (page, pageSize, length) {
            ...
            var endIndex = startIndex < length ?
                ...
                startIndex + pageSize;
            return _this.translateService.instant('ma.sc5.tableWrapper.pagination.rangeLabel', { start: startIndex + 1, end: endIndex, total: length });
        };
    }
    ...
    MaSc5TableWrapperComponent.prototype.selectCurrentPage = function () {
        var _this = this;
    ...
    MaSc5TableWrapperComponent.prototype.refreshList = function () {
