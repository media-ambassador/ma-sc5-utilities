...
var MaSc5UtilsService = /** @class */ (function () {
    ...
    MaSc5UtilsService.prototype.redirectToService = function (name, timeout) {
        var _this = this;
        if (timeout === void 0) { timeout = 0; }
        setTimeout(function () {
            window.location.href = window.location.protocol + "//" + window.location.host + "/" + name + "/" + _this.modulePrefix + "/";
        }, timeout);
    };
    MaSc5UtilsService.prototype.getServiceUrl = function (moduleName) {
        return window.location.protocol + "//" + window.location.host + "/" + moduleName + "/" + this.modulePrefix + "/";
    };
    MaSc5UtilsService.prototype.getCatalogueName = function (name) {
        return this.translate.instant("ma.sc5.catalogue.title." + name);
    };
    MaSc5UtilsService.prototype.getServiceName = function (name) {
